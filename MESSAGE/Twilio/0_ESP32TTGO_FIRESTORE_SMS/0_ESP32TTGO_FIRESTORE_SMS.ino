...
bool getTemperature() {
  ...
  String msgBody = "";
  if (newValues.temperature >28 || newValues.temperature <18){
    msgBody += "Temperature: ";
    msgBody += String(newValues.temperature, 1) +"'C\n";
  }

  if(newValues.humidity > 60 || newValues.humidity < 20){
    msgBody += "Humidity: ";
    msgBody += String(newValues.humidity, 0) +"%\n";
  }
